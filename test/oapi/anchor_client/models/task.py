...
class Task:
    ...
    Attributes:
        ...
        unique_tag (Union[Unset, str]): Unique tag of the task
    ...
    created_at: datetime.datetime
    updated_at: datetime.datetime
    unique_tag: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if unique_tag is not UNSET:
            field_dict["uniqueTag"] = unique_tag
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unique_tag = d.pop("uniqueTag", UNSET)
