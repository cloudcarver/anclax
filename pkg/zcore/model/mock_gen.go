...
func (m *MockModelInterface) RunTransactionWithTx(ctx context.Context, f func(Tx, ModelInterface) error) error {
	m.ctrl.T.Helper()
...
func (m *MockModelInterface) SpawnWithTx(tx Tx) ModelInterface {
	m.ctrl.T.Helper()
