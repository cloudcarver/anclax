...
func (m *MockTaskHandler) HandleTask(ctx context.Context, tx model.Tx, spec TaskSpec) error {
	m.ctrl.T.Helper()
...
func (m *MockTaskHandler) OnTaskFailed(ctx context.Context, tx model.Tx, failedTaskSpec TaskSpec, taskID int32) error {
	m.ctrl.T.Helper()
...
func (m *MockTaskLifeCycleHandlerInterface) HandleAttributes(ctx context.Context, tx model.Tx, task apigen.Task) error {
	m.ctrl.T.Helper()
...
func (m *MockTaskLifeCycleHandlerInterface) HandleCompleted(ctx context.Context, tx model.Tx, task apigen.Task) error {
	m.ctrl.T.Helper()
...
func (m *MockTaskLifeCycleHandlerInterface) HandleFailed(ctx context.Context, tx model.Tx, task apigen.Task, err error) error {
	m.ctrl.T.Helper()
