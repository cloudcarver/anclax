...
type TaskRunner interface { 
    ...
    // Delete an opaque key
	RunDeleteOpaqueKeyWithTx(ctx context.Context, tx model.Tx, params *DeleteOpaqueKeyParameters, overrides ...taskcore.TaskOverride) (int32, error)
}
...
func (c *Client) RunDeleteOpaqueKeyWithTx(ctx context.Context, tx model.Tx, params *DeleteOpaqueKeyParameters, overrides ...taskcore.TaskOverride) (int32, error) {
...
type ExecutorInterface interface { 
    // Delete an opaque key
	ExecuteDeleteOpaqueKey(ctx context.Context, tx model.Tx, params *DeleteOpaqueKeyParameters) error

	// Hook called when deleteOpaqueKey fails
	OnDeleteOpaqueKeyFailed(ctx context.Context, taskID int32, params *DeleteOpaqueKeyParameters, tx model.Tx) error
}
