...
// EventSpecType defines enum values
type EventSpecType string

// TaskEvents defines enum values
type TaskEvents string

// TaskStatus defines enum values
...
func (c *Client) SignUp(ctx context.Context, body SignUpJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	...
	return c.SignUpWithBody(ctx, "application/json", bytes.NewReader(bodyBytes), reqEditors...)
}
...
func (c *Client) SignIn(ctx context.Context, body SignInJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	...
	return c.SignInWithBody(ctx, "application/json", bytes.NewReader(bodyBytes), reqEditors...)
}
...
func (c *Client) RefreshToken(ctx context.Context, body RefreshTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	...
	return c.RefreshTokenWithBody(ctx, "application/json", bytes.NewReader(bodyBytes), reqEditors...)
}
...
// NewSignUpRequestWithBody generates requests for SignUp with any body
...
// NewSignUpRequest generates requests for SignUp
func NewSignUpRequest(server string, body SignUpJSONRequestBody) (*http.Request, error) {
	bodyBytes, err := json.Marshal(body)
	if err != nil {
		return nil, err
	}
	return NewSignUpRequestWithBody(server, "application/json", bytes.NewReader(bodyBytes))
}
...
// NewSignInRequestWithBody generates requests for SignIn with any body
...
func NewSignInRequest(server string, body SignInJSONRequestBody) (*http.Request, error) {
	...
	return NewSignInRequestWithBody(server, "application/json", bytes.NewReader(bodyBytes))
}

// NewRefreshTokenRequestWithBody generates requests for RefreshToken with any body
...
func NewRefreshTokenRequest(server string, body RefreshTokenJSONRequestBody) (*http.Request, error) {
	...
	return NewRefreshTokenRequestWithBody(server, "application/json", bytes.NewReader(bodyBytes))
}
...
func NewTryExecuteTaskRequest(server string, taskID int32) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/tasks/%v/try-execute", taskID)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func ParseListTasksResponse(rsp *http.Response) (*ListTasksResponse, error) {
	...
	response := &ListTasksResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseListOrgsResponse(rsp *http.Response) (*ListOrgsResponse, error) {
	...
	response := &ListOrgsResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseListEventsResponse(rsp *http.Response) (*ListEventsResponse, error) {
	...
	response := &ListEventsResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseSignUpResponse(rsp *http.Response) (*SignUpResponse, error) {
	...
	response := &SignUpResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseSignOutResponse(rsp *http.Response) (*SignOutResponse, error) {
	...
	response := &SignOutResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseSignInResponse(rsp *http.Response) (*SignInResponse, error) {
	...
	response := &SignInResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseRefreshTokenResponse(rsp *http.Response) (*RefreshTokenResponse, error) {
	...
	response := &RefreshTokenResponse{Body: bodyBytes, HTTPResponse: rsp}
...
func ParseTryExecuteTaskResponse(rsp *http.Response) (*TryExecuteTaskResponse, error) {
	...
	response := &TryExecuteTaskResponse{Body: bodyBytes, HTTPResponse: rsp}
