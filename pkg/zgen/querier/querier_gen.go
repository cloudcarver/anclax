...
type Querier interface {
	...
	ConsumeOpaqueKey(ctx context.Context, arg ConsumeOpaqueKeyParams) (int64, error)
	CreateKeyPair(ctx context.Context, arg CreateKeyPairParams) (*AnclaxAccessKeyPair, error)
	CreateOpaqueKey(ctx context.Context, arg CreateOpaqueKeyParams) (*CreateOpaqueKeyRow, error)
