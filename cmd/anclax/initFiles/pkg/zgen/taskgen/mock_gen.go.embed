...
func (m *MockTaskRunner) RunAutoIncrementCounter(ctx context.Context, params *counter.IncrementCounterParams, overrides ...store.TaskOverride) (int32, error) {
	m.ctrl.T.Helper()
...
func (m *MockTaskRunner) RunAutoIncrementCounterWithTx(ctx context.Context, tx core.Tx, params *counter.IncrementCounterParams, overrides ...store.TaskOverride) (int32, error) {
	m.ctrl.T.Helper()
...
func (m *MockTaskRunner) RunIncrementCounter(ctx context.Context, params *counter.IncrementCounterParams, overrides ...store.TaskOverride) (int32, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, params}
	for _, a := range overrides {
		varargs = append(varargs, a)
...
func (m *MockTaskRunner) RunIncrementCounterWithTx(ctx context.Context, tx core.Tx, params *counter.IncrementCounterParams, overrides ...store.TaskOverride) (int32, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, tx, params}
	for _, a := range overrides {
		varargs = append(varargs, a)
...
func (m *MockExecutorInterface) ExecuteAutoIncrementCounter(ctx context.Context, task worker.Task, params *counter.IncrementCounterParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteAutoIncrementCounter", ctx, task, params)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExecuteAutoIncrementCounter indicates an expected call of ExecuteAutoIncrementCounter.
func (mr *MockExecutorInterfaceMockRecorder) ExecuteAutoIncrementCounter(ctx, task, params any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockExecutorInterface) ExecuteIncrementCounter(ctx context.Context, task worker.Task, params *counter.IncrementCounterParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecuteIncrementCounter", ctx, task, params)
	ret0, _ := ret[0].(error)
	return ret0
}
